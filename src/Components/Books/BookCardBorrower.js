        ...
        <div className="column is-4">
            <Modal isOpen={this.state.showModal} onRequestClose={this.hideModal}>
                ...
                <DatePicker 
                    ...
                    minDate={new Date()}
                />
                <textarea name="comments" rows="5" onChange={this.handleInputChange}></textarea>
                <div>
            ...
            <div className="card">
                ...
                <div className="card-content">
                    <div className="media">
                        ...
                        <div>
                            ...
                            <p>
                                <span><small className="has-text-weight-bold px-1">Owner:</small></span>
                ...
                <div className="card-footer">
                    <button onClick={this.displayaModal} className="button is-primary is-small mr-2">Request</button>
